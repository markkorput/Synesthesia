...
(function() {
  var ClientOrient, OrientCollection, OrientModel, Orients, _ref, _ref1,
  ...
  OrientCollection = (function(_super) {
    __extends(OrientCollection, _super);

    function OrientCollection() {
      _ref1 = OrientCollection.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    OrientCollection.prototype.model = OrientModel;

    OrientCollection.prototype.initialize = function() {
      var _this = this;
      return this.on('change:orientation', function(model, val, obj) {
        var time;
  ...
  Orients = (function() {
    function Orients(opts) {
      ...
      this.clients = new OrientCollection();
      this.initScene();
      this.animate();
      ...
      this.clients.on('remove', function(model) {
        if (model.clientOrient) {
          return _this.scene.remove(model.clientOrient.mesh);
        }
      });
